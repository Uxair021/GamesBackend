...
/**
 * Gems Deluxe's bonus round is the first feature in this codebase where the final payout
 ...
 * offers are pre-rolled server-side at spin time (see games/GemsDeluxe/engine.ts's
 ...
 */
export interface IGemsDeluxeBonus extends Document {
...
const gemsDeluxeBonusSchema = new Schema<IGemsDeluxeBonus>({
...
export const GemsDeluxeBonus = model<IGemsDeluxeBonus>("GemsDeluxeBonus", gemsDeluxeBonusSchema);
