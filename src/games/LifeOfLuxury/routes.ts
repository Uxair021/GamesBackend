...
/**
 * Life of Luxury is a fully offline, client-side test game — RNG, win math, and balance are
 * computed entirely in the browser (see frontEnd/src/games/LifeOfLuxury/api.ts), nothing here
