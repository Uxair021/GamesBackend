...
/**
 * Buffalo 777 is a fully offline, client-side test game — RNG and balance are computed
 * entirely in the browser (see frontEnd/src/games/Buffalo777/api.ts), nothing here decides
 * or verifies the outcome. This is a pure write-only logging sink: the client reports what
 * already happened, purely for record-keeping alongside every other game's SpinHistory, and
